...
export const metadata: Metadata = {
    title: "Mussakka Restaurant İndirimi | Villa Tatilinde",
    description:
        "Villa Tatilinde tarafından sağlanan ve sunulan Kalkan Mussakka Restaurant İndirimi.",
};

/* ─── Promo pills data ─── */
const pills = [
    { href: "/qr-indirimleri-vati", label: "Vati Ocakbaşı %15 İndirim", width: 220, active: false },
    { href: "", label: "Mussakka Restaurant %15 İndirim", width: 260, active: true },
...
/* ─── Gallery images ─── */
const galleryImages = [
    { src: "/images/muss3.jpg", colStart: 1, colEnd: 12, rowStart: 1, rowEnd: 3 },
    { src: "/images/muss02.jpeg", colStart: 12, colEnd: 17, rowStart: 1, rowEnd: 2 },
    { src: "/images/muss03.jpeg", colStart: 17, colEnd: 21, rowStart: 1, rowEnd: 2 },
    { src: "/images/muss04.jpeg", colStart: 12, colEnd: 17, rowStart: 2, rowEnd: 3 },
    { src: "/images/muss01.jpeg", colStart: 17, colEnd: 21, rowStart: 2, rowEnd: 3 },
];

export default function QrIndirimleriMusakkaPage() {
    return (
        <div>
                            ...
                            <div className="paddingMobile">
                                <div style={{ padding: "calc(2vh + 2vw) 0" }}>
                                    ...
                                    >
                                        ...
                                        <br /> Mussakka Restaurant İndirimi
                                    </div>
                                    <div
                                        style={{
                                            textAlign: "left",
                                    ...
                                    >
                                        ...
                                        <div style={{ marginTop: 6 }}>
                                            <a
                                                href="https://www.tripadvisor.com.tr/Restaurant_Review-g297964-d1490638-Reviews-Mussakka_Restaurant-Kalkan_Turkish_Mediterranean_Coast.html"
                                                target="_blank"
                                            ...
                                            >
                                                &bull; Mussakka Restaurant
                                            </a>{" "}
                                            tripadvisor sayfasını ziyaret edin
                                        </div>
                                        <div style={{ marginTop: 6 }}>
                                            <a
                                                href="https://www.instagram.com/villatatilinde/mussakkarestaurant/?igsh=MWFhMm9hcXA0cHMzNA%3D%3D#"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                style={{
                                                    textDecoration: "underline",
                                ...
                                <div className="cntc31">
                                    ...
                                    >
                                        ...
                                        <div className="poppins officeTextUn">
                                            Kalkan Merkez Mussakka Restaurant
                                        </div>
                                        <div className="dm-sans officeAddress">
                                            Mussakka restaurant promosyonu
                                        </div>
                                    </div>
                                </div>
                                <div className="cntc32">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3216.9558665764603!2d29.412552276237555!3d36.26485039769348!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14c02cd5bba33127%3A0x2e36ab6b553f8fbb!2sMussakka%20Restaurant!5e0!3m2!1sen!2str!4v1733101124349!5m2!1sen!2str"
                                        width="100%"
                                        height="340"
