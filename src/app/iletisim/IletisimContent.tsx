                        ...
                        <div className="cntc31">
                            <div style={{ marginRight: 12, textAlign: "left", width: "100%" }}>
                                <div className="middleft">
                                    ...
                                    >
                                        <source src="/images/ovid.mp4" type="video/mp4" />
