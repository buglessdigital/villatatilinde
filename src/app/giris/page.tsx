...
const getTurkishErrorMessage = (errorMessage: string) => {
    if (errorMessage.includes("Email not confirmed")) {
        return "E-posta adresiniz henüz doğrulanmamış. Lütfen gelen kutunuzu (veya spam klasörünü) kontrol edip e-postanızı doğrulayın.";
    }
    if (errorMessage.includes("Invalid login credentials")) {
        return "E-posta adresiniz veya şifreniz hatalı.";
    }
    if (errorMessage.includes("User already registered")) {
        return "Bu e-posta adresi ile daha önce kayıt olunmuş.";
    }
    ...
    const handleEmailAuth = async (e: React.FormEvent) => {
        ...
        try {
            if (isSignUp) {
                ...
                if (error) {
                    setError(getTurkishErrorMessage(error.message));
                } else {
