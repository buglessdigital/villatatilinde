            ...
            <div className="footer-desktop footer-container">
                ...
                <div className="footer-row">
                    ...
                    <div className="f2c">
                        ...
                        <div className="linkType1 footer-link" style={{ cursor: "pointer" }}>Referans Kodu İle Villa Arama</div>
                    ...
                    <div className="f3c">
                        ...
                        <Link href="/kupon-olustur"><div className="linkType2 footer-link">Kupon Kodu Oluştur</div></Link>
                        <Link href="/villami-kirala"><div className="linkType2 footer-link" style={{ color: "#0cbc87", fontWeight: 600 }}>Villamı Kiraya Vermek İstiyorum</div></Link>
                    </div>
                ...
                {/* ═══════════════ BOTTOM BAR ═══════════════ */}
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", color: "#888", fontSize: 13, paddingTop: 16, paddingBottom: 32, flexWrap: "wrap", gap: 16 }}>
                    <div>©Villatatilinde — Praedium Group</div>
                    <div style={{ display: "flex", gap: 24, flexWrap: "wrap", justifyContent: "center" }}>
                        {policies.length > 0 ? (
                            policies.map(policy => (
                                <Link key={policy.id} href={`/politika/${policy.slug}`} className="footer-link">
                                    {policy.title}
                                </Link>
                            ))
                        ) : (
            ...
            <div className="footer-mobile" style={{ display: "none", padding: "40px 20px 100px 20px", fontFamily: "'Poppins', sans-serif" }}>
                ...
                <div style={{ marginTop: 24 }}>
                    ...
                    <div style={{ marginBottom: 32 }}>
                        ...
                        <Link href="/villami-kirala" style={{ display: "block", color: "#0cbc87", fontSize: 13, marginTop: 16, fontWeight: 600, textDecoration: "none" }}>Villamı Kiraya Vermek İstiyorum</Link>
                    </div>
                    ...
                    <div style={{ display: "flex", gap: 24, marginBottom: 16, flexWrap: "wrap" }}>
                        {policies.length > 0 ? (
                            policies.map(policy => (
                                <Link key={policy.id} href={`/politika/${policy.slug}`} style={{ color: "#fff", fontSize: 13, textDecoration: "none" }}>
                                    {policy.title}
                                </Link>
                            ))
                        ) : (
                ...
                <div style={{ textAlign: "center", marginTop: 40, borderTop: "1px solid #ffffff22", paddingTop: 32 }}>
                    <Link href="/" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
