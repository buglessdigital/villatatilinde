        ...
        >
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px", position: "relative" }}>
                ...
                <div style={{
                    ...
                    <input
                        type="text"
                        placeholder="Villa İsmi İle Ara"
                        value={searchTerm}
                    ...
                    />
                    <img src="/images/search3.png" style={{ marginLeft: 6, height: 16, opacity: 0.8 }} alt="" />
                </div>
                ...
                <div style={{ display: isLocationOpen ? "none" : "block" }}>
                    ...
                    {/* Kategoriler */}
                    <div style={{ marginBottom: 32 }}>
                        <div style={{ fontWeight: 700, fontSize: 19, color: "#8a8ea0", marginBottom: 14, letterSpacing: "-0.5px" }}>Kateoriler</div>
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                            {catTags.map(t => (
                                <div
                                    key={t.key}
