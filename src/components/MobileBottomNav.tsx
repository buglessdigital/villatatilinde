...
export default function MobileBottomNav() {
    ...
    const defaultNavItems = [
        {
            label: "Ana sayfa",
            icon: (
                <svg viewBox="0 0 24 24" fill={pathname === "/" ? "#3B82F6" : "#6b7280"} width="22" height="22">
        ...
        },
        {
            label: "Fırsatlar",
            icon: (
                <svg viewBox="0 0 24 24" fill={pathname === "/indirimli-villalar" ? "#222" : "#6b7280"} width="22" height="22">
        ...
        },
        {
            ...
            icon: (
                <div style={{ position: "relative" }}>
                    <svg viewBox="0 0 24 24" fill={pathname === "/bildirimler" ? "#222" : "#6b7280"} width="22" height="22">
        ...
        },
        {
            label: "Hesabım",
            icon: (
                <svg viewBox="0 0 24 24" fill={pathname === "/hesabim" ? "#222" : "#6b7280"} width="22" height="22">
    ...
    const searchNavItems = [
        ...
        },
        {
            ...
            icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="#6b7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" width="22" height="22">
                ...
                {activeNavItems.map((item, idx) => (
                    item.external ? (
                        ...
                        >
                            ...
                            <span style={{ fontSize: 11, fontWeight: 500, color: item.color, letterSpacing: "-0.2px" }}>{item.label}</span>
                        </a>
                    ) : (
                        <Link
                            key={idx}
                        ...
                        >
                            <div style={{ marginBottom: 4 }}>{item.icon}</div>
                            <span style={{ fontSize: 11, fontWeight: item.path === pathname ? 600 : 500, color: item.color, letterSpacing: "-0.2px" }}>{item.label}</span>
                        </Link>
                    )
                ))}
            </div>
