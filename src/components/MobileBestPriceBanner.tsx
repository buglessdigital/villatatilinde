    ...
    const ContactLinks = () => (
        <div style={{ marginTop: 24, paddingTop: 16, borderTop: "1px solid #bceab7" }}>
            ...
            <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
                <a href="https://wa.me/905320000000" style={{ display: "flex", alignItems: "center", gap: 6, color: "#008a20", fontSize: 14, textDecoration: "none" }}>
                    <img src="/images/wp.svg" style={{ width: 16 }} alt="" /> WhatsApp
                </a>
                <a href="tel:+905320000000" style={{ display: "flex", alignItems: "center", gap: 6, color: "#008a20", fontSize: 14, textDecoration: "none" }}>
